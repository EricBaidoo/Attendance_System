...
$page_title = 'System Logs - Bridge Ministries International';
$page_header = true;
$page_icon = 'bi bi-journal-text';
$page_heading = 'System Logs';
$page_description = 'Trace application errors and activity across the platform.';
$page_actions = '<a href="../../index" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Back to Dashboard</a>';
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body p-4">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                <div>
                    <h3 class="mb-1">Application Log Viewer</h3>
                    <p class="text-muted mb-0">Review recent errors and activity from the shared log files.</p>
                </div>
                <div class="btn-group" role="group" aria-label="Log type">
